...
export const HS_FMCG: HsEntry[] = [
  ...
  { code: '0403', en: 'Yoghurt, laban, buttermilk', ar: 'زبادي، لبن، لبن رائب', duty: 5 },
  { code: '0404', en: 'Whey & milk constituents', ar: 'مصل الحليب ومكوناته', duty: 5 },
  { code: '0405', en: 'Butter & dairy spreads', ar: 'زبدة ودهون ألبان', duty: 5 },
  { code: '0406', en: 'Cheese & curd', ar: 'جبن', duty: 5 },
  { code: '0407', en: 'Eggs in shell', ar: 'بيض بقشره', duty: 'verify' },
  { code: '0409', en: 'Natural honey', ar: 'عسل طبيعي', duty: 5 },
  // Ch 07 vegetables
  ...
  { code: '0904', en: 'Pepper, chilli, paprika', ar: 'فلفل، شطة، بابريكا', duty: 5 },
  { code: '0906', en: 'Cinnamon', ar: 'قرفة', duty: 5 },
  { code: '0908', en: 'Nutmeg, cardamom', ar: 'جوزة الطيب، هيل', duty: 5 },
  { code: '0909', en: 'Cumin, anise, coriander seeds', ar: 'كمون، يانسون، كزبرة', duty: 5 },
  { code: '0910', en: 'Ginger, saffron, turmeric, spice mixes', ar: 'زنجبيل، زعفران، كركم، خلطات بهارات', duty: 5 },
  ...
  { code: '1102', en: 'Other cereal flours', ar: 'دقيق حبوب أخرى', duty: 5 },
  { code: '1104', en: 'Rolled oats & worked grains', ar: 'شوفان مجروش وحبوب معالجة', duty: 5 },
  { code: '1108', en: 'Starches', ar: 'نشاء', duty: 5 },
  // Ch 12 seeds
  ...
  { code: '1211', en: 'Herbs for infusions / pharmacy', ar: 'أعشاب للمشروبات / الصيدلة', duty: 5 },
  // Ch 15 oils
  { code: '1507', en: 'Soybean oil', ar: 'زيت فول الصويا', duty: 5 },
  { code: '1509', en: 'Olive oil', ar: 'زيت زيتون', duty: 5 },
  { code: '1511', en: 'Palm oil', ar: 'زيت نخيل', duty: 5 },
  { code: '1512', en: 'Sunflower / safflower oil', ar: 'زيت دوار الشمس / القرطم', duty: 5 },
  { code: '1514', en: 'Rapeseed / canola oil', ar: 'زيت الكانولا', duty: 5 },
  { code: '1517', en: 'Margarine & blended fats', ar: 'مارجرين ودهون مخلوطة', duty: 5 },
  // Ch 16 prepared meat/fish
  { code: '1601', en: 'Sausages', ar: 'سجق ونقانق', duty: 5 },
  { code: '1602', en: 'Prepared / preserved meat (luncheon, corned beef)', ar: 'لحوم محضرة أو محفوظة (لانشون، كورنيد بيف)', duty: 5 },
  { code: '1604', en: 'Prepared / canned fish (tuna, sardines)', ar: 'أسماك محضرة أو معلبة (تونة، سردين)', duty: 5 },
  { code: '1605', en: 'Prepared crustaceans & molluscs', ar: 'قشريات ورخويات محضرة', duty: 5 },
  // Ch 17–18 sugar, cocoa
  { code: '1701', en: 'Cane / beet sugar', ar: 'سكر قصب / بنجر', duty: 'verify', note: 'Raw/refined sugar is commonly exempt' },
  { code: '1702', en: 'Other sugars, glucose, syrups', ar: 'سكريات أخرى، جلوكوز، شراب', duty: 5 },
  { code: '1704', en: 'Sugar confectionery (no cocoa)', ar: 'حلويات سكرية (بدون كاكاو)', duty: 5 },
  { code: '1801', en: 'Cocoa beans', ar: 'حبوب كاكاو', duty: 'verify' },
  { code: '1806', en: 'Chocolate & cocoa preparations', ar: 'شوكولاتة ومحضرات كاكاو', duty: 5 },
  ...
  { code: '1901', en: 'Malt extract; flour/milk preparations', ar: 'خلاصة شعير؛ محضرات دقيق/حليب', duty: 5 },
  { code: '1902', en: 'Pasta & noodles', ar: 'معكرونة ونودلز', duty: 5 },
  { code: '1904', en: 'Breakfast cereals & puffed grains', ar: 'حبوب إفطار وحبوب منفوشة', duty: 5 },
  { code: '1905', en: 'Bread, biscuits, pastry, wafers', ar: 'خبز، بسكويت، معجنات، ويفر', duty: 5 },
  // Ch 20 prepared veg/fruit
  { code: '2001', en: 'Pickles (in vinegar)', ar: 'مخللات (بالخل)', duty: 5 },
  { code: '2002', en: 'Tomatoes prepared (paste, canned)', ar: 'طماطم محضرة (معجون، معلبة)', duty: 5 },
  { code: '2005', en: 'Other prepared vegetables (olives, beans, hummus)', ar: 'خضروات محضرة أخرى (زيتون، فول، حمص)', duty: 5 },
  { code: '2007', en: 'Jams, jellies, fruit purées', ar: 'مربيات، جيلي، هريس فواكه', duty: 5 },
  { code: '2008', en: 'Fruit & nuts prepared (canned fruit, roasted nuts)', ar: 'فواكه ومكسرات محضرة (فواكه معلبة، مكسرات محمصة)', duty: 5 },
  { code: '2009', en: 'Fruit & vegetable juices', ar: 'عصائر فواكه وخضروات', duty: 5, excise: 'sweet', note: 'Sweetened juice drinks fall under the 2026 sugar tiers' },
  // Ch 21 misc preparations
  { code: '2101', en: 'Coffee & tea extracts (instant coffee)', ar: 'خلاصات قهوة وشاي (قهوة سريعة الذوبان)', duty: 5 },
  { code: '2102', en: 'Yeasts & baking powders', ar: 'خمائر ومساحيق خبز', duty: 5 },
  { code: '2103', en: 'Sauces, ketchup, mayonnaise, mustard, seasonings', ar: 'صلصات، كاتشب، مايونيز، خردل، توابل', duty: 5 },
  { code: '2104', en: 'Soups & broths', ar: 'شوربات ومرق', duty: 5 },
  { code: '2105', en: 'Ice cream', ar: 'آيس كريم', duty: 5 },
  { code: '2106', en: 'Food preparations n.e.s. (supplements, syrups, protein powders)', ar: 'محضرات غذائية غير مذكورة (مكملات، شراب، مساحيق بروتين)', duty: 5 },
  // Ch 22 beverages
  { code: '2201', en: 'Water incl. mineral & sparkling, no sugar', ar: 'مياه معدنية وغازية بدون سكر', duty: 5 },
  { code: '2202.10', en: 'Sweetened / flavoured water & carbonated drinks', ar: 'مياه محلّاة/منكّهة ومشروبات غازية', duty: 5, excise: 'sweet' },
  { code: '2202.99', en: 'Other non-alcoholic beverages (energy drinks, iced tea, plant milks)', ar: 'مشروبات غير كحولية أخرى (مشروبات طاقة، شاي مثلج، حليب نباتي)', duty: 5, excise: 'sweet', note: 'Energy drinks: choose the energy excise (100%)' },
  { code: '2203', en: 'Beer', ar: 'بيرة', duty: 50 },
  { code: '2204', en: 'Wine', ar: 'نبيذ', duty: 50 },
  { code: '2208', en: 'Spirits & liqueurs', ar: 'مشروبات روحية', duty: 50 },
  // Ch 23 feed
  { code: '2309.10', en: 'Dog & cat food, retail', ar: 'أغذية كلاب وقطط (تجزئة)', duty: 5 },
  { code: '2309.90', en: 'Other animal feed preparations', ar: 'محضرات أعلاف أخرى', duty: 5 },
  // Ch 24 tobacco
  ...
  // Ch 25 salt
  { code: '2501', en: 'Salt', ar: 'ملح', duty: 5 },
