...
export const GSO9 = {
  ...
  description: {
    en: 'What GSO 9 requires on an Arabic food label in the UAE — mandatory items, compliance checklist, the translation trap, and compliant Arabic label printing.',
  ...
  checklist: {
    ...
    rows: [
      ...
      { item: { en: 'Nutrition', ar: 'البيان الغذائي' }, req: { en: 'Nutritional declaration', ar: 'إعلان القيم الغذائية' }, fmt: { en: 'Table per 100 g or 100 ml (energy, fat, carbohydrate, sugars, protein, salt)', ar: 'جدول لكل 100 غ أو 100 مل: الطاقة، الدهون، المشبعة، الكربوهيدرات، السكريات، البروتين، الملح/الصوديوم' } },
  ...
  trap: {
    ...
    items: [
      { en: 'Additives: an E number alone is not enough. The functional class (preservative, acidity regulator, emulsifier) must appear in Arabic with the number, using the standard Arabic names.', ar: 'المضافات: رقم E وحده لا يكفي. المطلوب الفئة الوظيفية (مادة حافظة، منظم حموضة، مستحلب) بالعربية مع الرقم، بالأسماء العربية المعيارية.' },
      ...
      { en: 'Layout: Arabic reads right-to-left. A label built in a left-to-right template mixes lines and separates values from their headings.', ar: 'التنسيق: العربية تُقرأ من اليمين إلى اليسار. الملصق المبني على قالب يساري يخلط الأسطر ويقطع الصلة بين القيمة وعنوانها.' },
    ],
  },
  ...
  helps: {
    ...
    items: [
      { href: '/tools/product-registration-uae', title: { en: 'Product registration', ar: 'تسجيل المنتج' }, body: { en: 'Dubai Municipality (Montaji for cosmetics and supplements; FIRS for food, with the federal ZAD system) or ADAFSA in Abu Dhabi. Our Portal Router shows the authority, portal, official fees and documents for your product.', ar: 'بلدية دبي (منتاجي لمستحضرات التجميل والمكملات؛ FIRS للأغذية مع نظام زاد الاتحادي) أو ADAFSA في أبوظبي. يُظهر موجّه البوابات الجهة والبوابة والرسوم الرسمية وقائمة المستندات لمنتجك.' }, link: { en: 'Product Registration Service', ar: 'خدمة تسجيل المنتج' } },
      { href: '/import', title: { en: 'Import and trading', ar: 'الاستيراد والتجارة' }, body: { en: 'HS code, customs duty, ECAS / EQM / halal certificates and landed cost per product, plus market opportunities and licensed suppliers in the trading section.', ar: 'رمز HS والرسوم الجمركية وشهادات ECAS / EQM / الحلال والتكلفة الواصلة لكل منتج، إضافة إلى قسم التجارة لفرص السوق والموردين المرخّصين.' }, link: { en: 'Import and Trading', ar: 'الاستيراد والتجارة' } },
  ...
  printing: {
    ...
    cards: [
      { title: { en: 'Over-stickering for imported consignments', ar: 'ملصق إضافي للإرساليات المستوردة' }, body: { en: 'A compliant Arabic sticker applied over or beside the original label, covering nothing mandatory and leaving the manufacturer’s dates visible.', ar: 'ملصق عربي مطابق يُلصق فوق الملصق الأصلي أو بجانبه. لا يغطي أي بيان إلزامي ويُبقي تاريخي الإنتاج والانتهاء من المصنّع ظاهرين.' } },
      { title: { en: 'Materials for real storage conditions', ar: 'خامات لظروف التخزين الحقيقية' }, body: { en: 'Paper (matt or gloss) for dry ambient goods; PVC / vinyl for moisture, oil, chilled and freezer storage — chosen for where the product actually lives.', ar: 'ورق (مطفي أو لامع) للسلع الجافة؛ PVC / فينيل للرطوبة والزيوت والتبريد والتجميد. تُختار الخامة بحسب المكان الذي يعيش فيه المنتج فعلاً.' } },
      { title: { en: 'Compliance-aware artwork', ar: 'تصميم واعٍ بالمطابقة' }, body: { en: 'Mandatory sections in Arabic and English, legible sizes, right-to-left set correctly — from the same engine as our free pre-check.', ar: 'الأقسام الإلزامية مرتبة بالعربية والإنجليزية، بمقاسات مقروءة، وباتجاه صحيح من اليمين إلى اليسار — من المحرك نفسه الذي يشغّل فحصنا المجاني.' } },
  ...
  faq: {
    ...
    items: [
      { q: { en: 'Can I put an Arabic sticker over the original packaging?', ar: 'هل يمكنني وضع ملصق عربي فوق العبوة الأصلية؟' }, a: { en: 'Yes, when it is firmly affixed, legible and covers no mandatory information on the original pack. The manufacturer’s production and expiry dates must stay visible and may not be replaced by a sticker.', ar: 'نعم. يُقبل الملصق الإضافي إذا كان ثابتاً ومقروءاً ولا يغطي أي بيان إلزامي على العبوة الأصلية. ويجب أن يبقى تاريخا الإنتاج والانتهاء من المصنّع ظاهرين؛ ولا يجوز استبدالهما بملصق.' } },
      { q: { en: 'What happens if the allergens are not in Arabic?', ar: 'ماذا يحدث إذا لم تكن مسببات الحساسية بالعربية؟' }, a: { en: 'The label is non-compliant. Allergen declaration is a mandatory GSO 9 particular and must appear in Arabic; registration fails until it is corrected, and consignments can be held at the port of entry.', ar: 'يكون الملصق غير مطابق. إعلان مسببات الحساسية بيان إلزامي في GSO 9 ويجب أن يظهر بالعربية؛ لن يجتاز المنتج التسجيل حتى يُصحَّح، ويمكن حجز الإرساليات في منفذ الدخول.' } },
      ...
      { q: { en: 'Does the Arabic text have to be as large as the English?', ar: 'هل يجب أن يكون النص العربي بحجم النص الإنجليزي؟' }, a: { en: 'Arabic is the mandatory language; other languages are optional. The Arabic particulars must be clearly legible and not less prominent than the same information in another language.', ar: 'العربية هي اللغة الإلزامية؛ واللغات الأخرى إضافات اختيارية. يجب أن تكون البيانات العربية مقروءة بوضوح ولا تقل بروزاً عن المعلومات نفسها بلغة أخرى.' } },
      ...
      { q: { en: 'Can Crate translate an existing English label?', ar: 'هل تترجم Crate ملصقاً إنجليزياً قائماً؟' }, a: { en: 'Yes. We translate and re-set the label with regulatory terminology, then run it through the same pre-check built on the authority’s requirements.', ar: 'نعم. نترجم الملصق ونعيد تنسيقه بالمصطلحات التنظيمية، ثم نمرّره في الفحص نفسه الذي يحاكي متطلبات الجهة.' } },
      { q: { en: 'What is the minimum order, and how fast is delivery?', ar: 'ما الحد الأدنى للطلب، وكم تستغرق مدة التسليم؟' }, a: { en: 'Short digital runs from 100 labels, with turnaround confirmed on your quote. Rush production is available for consignments waiting at customs.', ar: 'كميات رقمية صغيرة بلا حد أدنى كبير — من 100 ملصق — ومدة تُؤكَّد في عرض السعر. ويتوفر إنتاج مستعجل للإرساليات المنتظرة في الجمارك.' } },
    ],
  },
  ...
  final: {
    ...
    body: {
      en: 'Send us the label or product data you have and we return a compliant proof and a printing quote. Registration support is available for products not yet filed.',
...
export const GSO9_SAMPLE_LABEL = {
  product_name: 'Oat & Honey Cookies 200 g',
  product_name_ar: 'بسكويت الشوفان والعسل 200 غ',
  net_content: '200 g / 200 غ',
  country_of_origin: 'Product of Turkey',
  origin_ar: 'منتج تركيا / Product of Turkey',
  ingredients: 'Ingredients: wheat flour, oat flakes 22%, sugar, butter (milk), honey 6%, egg, raising agent (sodium bicarbonate E500), salt.',
  ingredients_ar: 'المكوّنات: دقيق قمح، رقائق شوفان 22%، سكر، زبدة (حليب)، عسل 6%، بيض، عامل رفع (بيكربونات الصوديوم E500)، ملح.',
  allergens: 'Contains: gluten (wheat, oats), milk, egg. May contain traces of nuts and sesame.',
  allergens_ar: 'يحتوي على: غلوتين (قمح، شوفان)، حليب، بيض. قد يحتوي على آثار المكسرات والسمسم.',
  ...
  nutrition: {
    columns: ['Per 100 g / لكل 100 غ'],
    rows: [
      { label: 'Energy / الطاقة', values: ['470 kcal / 1970 kJ'] },
      { label: 'Fat / الدهون', values: ['20 g'] },
      { label: 'of which saturates / منها مشبعة', values: ['11 g'] },
      { label: 'Carbohydrate / الكربوهيدرات', values: ['65 g'] },
      { label: 'of which sugars / منها سكريات', values: ['25 g'] },
      { label: 'Protein / البروتين', values: ['6 g'] },
      { label: 'Salt / الملح', values: ['0.6 g'] },
    ],
  },
}
