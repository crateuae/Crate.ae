          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc_ar: 'أدخل الطلب: 2000 كيس رز 1.5كجم → يخرج: 3 طن + مصادر الشراء + توزيع الكراتين + الطبليّات + تكلفة كاملة + سعر مقترح + ليبل جاهز للطباعة',
                ...
                points_ar: ['حساب الوزن والكميات تلقائياً', 'توزيع الكراتين والطبليّات', 'ليبل احترافي وفق UAE.S 9:2019'],
