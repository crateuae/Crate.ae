...
const INITIAL: PackagingSpec[] = [
  { id: 'pk1', type: 'Bag', type_ar: 'كيس', icon: '👜', size: '1kg', dims_cm: '20×10×5 سم', max_weight_kg: 1, units_per_carton: 24, cartons_per_pallet: 60, material: 'PP Woven', material_ar: 'بولي بروبيلين منسوج', cost_aed: 0.5, suitable_for_ar: 'أرز، سكر، دقيق، بقوليات', suitable_for_en: 'Rice, sugar, flour, legumes', is_active: true },
  { id: 'pk2', type: 'Bag', type_ar: 'كيس', icon: '🛍️', size: '5kg', dims_cm: '40×20×10 سم', max_weight_kg: 5, units_per_carton: 6, cartons_per_pallet: 40, material: 'PP Woven', material_ar: 'بولي بروبيلين منسوج', cost_aed: 1.2, suitable_for_ar: 'أرز، دقيق، حبوب خشنة', suitable_for_en: 'Rice, flour, coarse grains', is_active: true },
  { id: 'pk3', type: 'Master Carton', type_ar: 'كرتون ماستر', icon: '📦', size: '30×20×15 سم', dims_cm: '30×20×15 سم', max_weight_kg: 12, units_per_carton: 12, cartons_per_pallet: 80, material: 'Corrugated B-flute', material_ar: 'كرتون مموج B', cost_aed: 3.5, suitable_for_ar: 'علب معلبة، منتجات خفيفة الوزن', suitable_for_en: 'Canned goods, lightweight products', is_active: true },
  { id: 'pk4', type: 'Master Carton', type_ar: 'كرتون ماستر', icon: '📦', size: '40×30×20 سم', dims_cm: '40×30×20 سم', max_weight_kg: 20, units_per_carton: 24, cartons_per_pallet: 50, material: 'Corrugated C-flute', material_ar: 'كرتون مموج C', cost_aed: 5.0, suitable_for_ar: 'عبوات زجاجية، زجاجات بلاستيك', suitable_for_en: 'Glass jars, plastic bottles', is_active: true },
  { id: 'pk5', type: 'Master Carton', type_ar: 'كرتون ماستر', icon: '🗃️', size: '60×40×30 سم', dims_cm: '60×40×30 سم', max_weight_kg: 30, units_per_carton: 48, cartons_per_pallet: 30, material: 'Corrugated BC-flute', material_ar: 'كرتون مموج BC', cost_aed: 8.0, suitable_for_ar: 'معلبات ثقيلة، زيوت', suitable_for_en: 'Heavy cans, oils', is_active: true },
  { id: 'pk6', type: 'Shrink Wrap', type_ar: 'تغليف حراري', icon: '🌯', size: 'قياسي', dims_cm: '—', max_weight_kg: 5, units_per_carton: 6, cartons_per_pallet: 0, material: 'PE Film', material_ar: 'فيلم بولي إيثيلين', cost_aed: 0.3, suitable_for_ar: 'زجاجات مياه، عبوات عصير', suitable_for_en: 'Water bottles, juice packs', is_active: true },
  { id: 'pk7', type: 'Pallet', type_ar: 'طبليّة', icon: '🏗️', size: '80×120 سم', dims_cm: '80×120×14 سم', max_weight_kg: 1000, units_per_carton: 0, cartons_per_pallet: 0, material: 'Plastic HDPE', material_ar: 'بلاستيك HDPE', cost_aed: 45, suitable_for_ar: 'جميع أنواع الشحن', suitable_for_en: 'All shipment types', is_active: true },
]

const EMPTY: Partial<PackagingSpec> = { type: 'Bag', type_ar: 'كيس', icon: '📦', size: '', dims_cm: '', max_weight_kg: 0, units_per_carton: 12, cartons_per_pallet: 0, material: '', material_ar: '', cost_aed: 0, suitable_for_ar: '', suitable_for_en: '', is_active: true }
            ...
            <div className="px-6 py-5 space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <input value={editItem.icon || ''} onChange={e => setEditItem(p => ({ ...p, icon: e.target.value }))}
                    placeholder="📦" className="w-24 border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-orange-400 text-center text-xl" />
                </div>
              </div>
